...
class BasicOperationsGenerator extends BaseGenerator {
  generatePowerProblem() {
    ...
    if (this.difficulty === "easy") {
      bases = MathUtils.randomInt(2, 5);
      nRange = [-5, 8];
      kRange = [1, 5];
      mRange = [1, 5];
    } else if (this.difficulty === "hard") {
      bases = MathUtils.randomInt(2, 15);
      nRange = [-15, 15];
      kRange = [-10, 10];
      mRange = [-15, 15];
    } else {
      // medium
      bases = MathUtils.randomInt(2, 9);
      nRange = [-8, 8];
      kRange = [-5, 5];
      mRange = [-8, 8];
    }
  ...
  generateRootsProblem() {
    ...
    if (this.difficulty === "easy") {
      roots = MathUtils.randomElement([2, 3, 5, 6, 7]);
      f1Range = [2, 10];
      f2Range = [1, 5];
      opList = ["+", "-"];
    } else if (this.difficulty === "hard") {
      roots = MathUtils.randomElement([2, 3, 5, 6, 7, 10, 11, 13, 14, 15]);
      f1Range = [5, 20];
      f2Range = [2, 15];
      opList = ["-", "+"];
    } else {
      roots = MathUtils.randomElement([2, 3, 5, 7, 10]);
      f1Range = [3, 12];
      f2Range = [2, 8];
      opList = ["-", "+"];
    }
  ...
  generateScientificProblem() {
    ...
    if (this.difficulty === "easy") {
      ...
      bBaseRange = [2, 15];
      multipliers = [1.5, 2.5, 0.5, 0.2, 0.1, 0.25];
      expRange = [-20, 20];
    } else {
      bBaseRange = [2, 9];
      multipliers = [2, 3, 4, 5, 1.5, 2.5, 0.5];
      expRange = [-12, 12];
    }
