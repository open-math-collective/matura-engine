const EconomicOptimizationGenerator = require("../src/engine/generators/functions/topics/optimization/EconomicOptimizationGenerator");

console.log("Running test for EconomicOptimizationGenerator...");

function runTest() {
  try {
    const generator = new EconomicOptimizationGenerator("hard");
    const iterations = 1000;

    const methods = ["generateRevenueProblem", "generateDensityProblem"];
