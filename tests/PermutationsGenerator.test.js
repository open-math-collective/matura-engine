const PermutationsGenerator = require("../src/engine/generators/combinatorics/topics/PermutationsGenerator");

console.log("Running test for PermutationsGenerator...");

function runTest() {
  try {
    const generator = new PermutationsGenerator("hard");
